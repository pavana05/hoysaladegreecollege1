    ...
    if (loading) {
      return (
        <div className="fixed inset-0 z-[200] flex flex-col items-center justify-center gap-6 overflow-hidden" style={{ background: "#050608" }}>
          ...
          {/* Logo */}
          <div className="relative z-10" style={{ animation: "ns-logo-in 0.8s cubic-bezier(0.16,1,0.3,1) forwards", opacity: 0 }}>
          ...
          {/* Title */}
          <div className="text-center relative z-10" style={{ animation: "ns-text-in 0.6s cubic-bezier(0.16,1,0.3,1) 0.3s both" }}>
          ...
          <style>{`
            ...
            @keyframes ns-logo-in { 0% { opacity: 0; transform: scale(0.7) translateY(8px); } 100% { opacity: 1; transform: scale(1) translateY(0); } }
            @keyframes ns-text-in { 0% { opacity: 0; transform: translateY(10px); } 100% { opacity: 1; transform: translateY(0); } }
          `}</style>
        </div>
      );
    }
